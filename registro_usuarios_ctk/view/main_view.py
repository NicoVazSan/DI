...
class MainView(ctk.CTk):
    def __init__(self):
        ...
        self.title("Registro de Usuarios (CTk + MVC) - Fase 1")
        ...
        self.lbl_nombre.grid(row=1, column=0, padx=10, pady=5, sticky="w")

        self.lbl_edad = ctk.CTkLabel(self.frame_detalles, text="Edad: -", anchor="w")
        self.lbl_edad.grid(row=2, column=0, padx=10, pady=5, sticky="w")

        self.lbl_genero = ctk.CTkLabel(self.frame_detalles, text="Género: -", anchor="w")
        self.lbl_genero.grid(row=3, column=0, padx=10, pady=5, sticky="w")

        self.lbl_avatar = ctk.CTkLabel(self.frame_detalles, text="Avatar: -", anchor="w")
        self.lbl_avatar.grid(row=4, column=0, padx=10, pady=5, sticky="w")
    ...
    def mostrar_detalles_usuario(self, usuario):
        ...
        self.lbl_avatar.configure(text=f"Avatar: {usuario.avatar}")